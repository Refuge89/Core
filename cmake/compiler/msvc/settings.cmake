...
if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS MSVC_EXPECTED_VERSION)
  message(FATAL_ERROR "MSVC: ReinsCoreWotlk requires version ${MSVC_EXPECTED_VERSION} (MSVC 2015) to build but found ${CMAKE_CXX_COMPILER_VERSION}")
endif()
...
if(NOT (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.0.23026.0))
  # makes this flag a requirement to build RCW at all
